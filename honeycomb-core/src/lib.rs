...
pub use model::{
    ...
    GroupId, Iri, LatticeConvention, Link, LinkId, Mode, ModelError, NewTile, OwnTile, OwnTileEdit,
    PinnedTile, Routing, Slug, Statement, Term, Text, TileId, Timestamp, Version, anchors,
    components, holes,
};
